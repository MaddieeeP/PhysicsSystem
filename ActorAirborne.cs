...
public class ActorAirborne : ActorState
{
    ...
    public override Vector3 up { get { return -_actor.gravity.normalized; } }
    ...
    public override void SimulationUpdate(ref Vector3 actualLinearVelocity, ref Vector3 actualAngularVelocity, float deltaTime)
    {
        ...
        float stepMaxAccelerationVelocityChange = _maxAcceleration * scaledDeltaTime * _moveAerialFriction;
        float stepMaxDecelerationVelocityChange = _maxDeceleration * scaledDeltaTime * _moveAerialFriction;
